...
assert.match(source, /Hot Radar Signals/, 'Control Room must show a Radar news section on home.')
assert.match(source, /What to catch/, 'Radar home UI must explain which news needs attention.')
