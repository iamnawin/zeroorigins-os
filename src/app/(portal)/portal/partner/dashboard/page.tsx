      ...
      <Card className="border-border bg-card">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Partner Status</CardTitle>
        ...
        <Card className="bg-destructive/10 border-destructive/20 border">
          <CardContent className="p-4 flex flex-col gap-2">
            <p className="text-sm text-destructive font-medium">
              You are signed in as PARTNER. Internal workspace requires FOUNDER, DIRECTOR, STAFF, or CONTRACTOR role.
            </p>
            {!isInternal && (
      ...
      <Card className="bg-card border-border">
        <CardContent className="p-12 text-center space-y-6">
          <div className="space-y-2">
            <p className="text-zo-amber text-2xl font-semibold">Partner Portal</p>
            <p className="text-muted-foreground max-w-md mx-auto">
              Coming soon. You&apos;ll be able to track referrals, commissions, and resources here.
            </p>
          </div>
