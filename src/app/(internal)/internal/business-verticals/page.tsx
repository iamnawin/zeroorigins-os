      ...
      {verticals.length > 0 ? (
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {verticals.map(vertical => (
            <Link key={vertical.id} href={`/internal/business-verticals/${vertical.id}`} className="group">
              <Card className="h-full border-border bg-card transition-colors group-hover:border-zo-purple/40">
